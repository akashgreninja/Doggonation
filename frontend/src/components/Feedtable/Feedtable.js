  ...
  return (
    <div className="" style={{ "margin-bottom": "50px", height: "vh-70" }}>
      ...
      <div className="  float-right right-7 w-80 flex flex-wrap  fixed">
        <div className=" ">
          <div class="bg-gray-500 block rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
